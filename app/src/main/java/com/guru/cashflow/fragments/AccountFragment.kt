...
class AccountFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(com.guru.cashflow.R.layout.fragment_account, container, false)
    }
    ...
    private fun swipeRefresh() {
        val swipeRefreshLayout: SwipeRefreshLayout = requireView().findViewById(com.guru.cashflow.R.id.swipeRefresh)
    ...
    private fun chartMenu() {
        val chartMenuRadio: RadioGroup = requireView().findViewById(com.guru.cashflow.R.id.RadioGroup)
        val pieChart: PieChart = requireView().findViewById(com.guru.cashflow.R.id.pieChart)
        val barChart: BarChart = requireView().findViewById(com.guru.cashflow.R.id.barChart)

        chartMenuRadio.setOnCheckedChangeListener { _, checkedID ->
            if (checkedID == com.guru.cashflow.R.id.rbBarChart){
                barChart.visibility = View.VISIBLE
                pieChart.visibility = View.GONE
            }
            if (checkedID == com.guru.cashflow.R.id.rbPieChart){
    ...
    private fun setInitDate() {
        val dateRangeButton: Button = requireView().findViewById(com.guru.cashflow.R.id.buttonDate)
    ...
    private fun accountDetails() {
        val tvName: TextView = requireView().findViewById(com.guru.cashflow.R.id.tvName)
        val tvEmail: TextView = requireView().findViewById(com.guru.cashflow.R.id.tvEmail)
        val tvPicture: TextView = requireView().findViewById(com.guru.cashflow.R.id.picture)
        val verified: CardView = requireView().findViewById(com.guru.cashflow.R.id.verified)
        val notVerified: CardView = requireView().findViewById(com.guru.cashflow.R.id.notVerified)
    ...
    private fun logout() {
        val btnLogout: ImageButton = requireView().findViewById(com.guru.cashflow.R.id.btnLogout)
    ...
    private fun showAllTimeRecap() {
        ...
        val tvNetAmount: TextView = requireView().findViewById(com.guru.cashflow.R.id.netAmount)
        val tvAmountExpense: TextView = requireView().findViewById(com.guru.cashflow.R.id.expenseAmount)
        val tvAmountIncome: TextView = requireView().findViewById(com.guru.cashflow.R.id.incomeAmount)
    ...
    private fun setupBarChart() {
        ...
        val netAmountRangeDate: TextView = requireView().findViewById(com.guru.cashflow.R.id.netAmountRange)
        ...
        barDataSet.setColors(
            resources.getColor(com.guru.cashflow.R.color.orangeSecondary),
            resources.getColor(com.guru.cashflow.R.color.purple)
        )
